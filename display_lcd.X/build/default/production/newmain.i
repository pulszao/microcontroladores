...
void main(void)
{
 ...
 display(3,"PAULA e RAFA");

    do
    {

        PORTCbits.RC4=0;
        for(tempo=0;tempo<0x3FFF;tempo++) continue;
        PORTCbits.RC4=1;
        for(tempo=0;tempo<0x3FFF;tempo++) continue;
...
void escrevedp_ini(char dado)
{
    PORTDbits.RD7 = (dado&0x8)>>3;
    PORTDbits.RD6 = (dado&0x4)>>2;
    PORTDbits.RD5 = (dado&0x2)>>1;
    PORTDbits.RD4 = (dado&0x1);
...
void escrevedp(char dado)
{
    PORTDbits.RD7 = (dado&0x80)>>7;
    PORTDbits.RD6 = (dado&0x40)>>6;
    PORTDbits.RD5 = (dado&0x20)>>5;
    PORTDbits.RD4 = (dado&0x10)>>4;
    PORTDbits.RD3 =1;
    PORTDbits.RD3 =0;
