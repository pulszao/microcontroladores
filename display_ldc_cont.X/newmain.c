 ...
 * Author: lcpulsz
 *
 * Created on 1 de Novembro de 2023, 20:27
 */
...
// OK: Escreve um contador de 0 a 999 no display LCD 16x2
...
void main(void) 
{
    ...
    {        
        ...
        if (tempo>0xFF70) {
            ...
            posdp(0x80); // primeira linha primeira coluna
            escrevedp(centena + '0');
            posdp(0x81); // primeira linha segunda coluna
            escrevedp(dezena + '0');
            posdp(0x82); // primeira linha terceira coluna
            escrevedp(unidade + '0');
        }
